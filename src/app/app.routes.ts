...
import { StepGuard } from './core/auth/guards/step.guard';
...
export const appRoutes: Route[] = [
    ...
    {path: '', pathMatch : 'full', redirectTo: 'upload-models'},
    ...
    {path: 'signed-in-redirect', pathMatch : 'full', redirectTo: 'upload-models'},
